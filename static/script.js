...
menu[1].addEventListener("click", function (e) {
  ...
  if (rows[0].id == "menu") {
    ...
    a[0].setAttribute("class", "home animate__backInLeft");
    a[1].setAttribute("class", "about animate__backInLeft");
    a[2].setAttribute("class", "skills animate__backInLeft");
    a[3].setAttribute("class", "projects animate__backInLeft");
    a[4].setAttribute("class", "contact animate__backInLeft");
  } else {
